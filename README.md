...
```bash
bash <(wget -qO- https://cdn.jsdelivr.net/gh/kuss0/caddy.sh@fb1705b28600667e50b4f38540db8770b02f8abd/install.sh)
```

或使用 curl：

```bash
bash <(curl -fsSL https://cdn.jsdelivr.net/gh/kuss0/caddy.sh@fb1705b28600667e50b4f38540db8770b02f8abd/install.sh)
```

普通用户用 sudo：

```bash
wget -qO- https://cdn.jsdelivr.net/gh/kuss0/caddy.sh@fb1705b28600667e50b4f38540db8770b02f8abd/install.sh | sudo bash
```

只安装脚本、不立即初始化：

```bash
bash <(wget -qO- https://cdn.jsdelivr.net/gh/kuss0/caddy.sh@fb1705b28600667e50b4f38540db8770b02f8abd/install.sh) --no-init
```
