...
```bash
bash <(wget -qO- https://github.com/kuss0/caddy.sh/raw/main/install.sh)
```

或使用 curl：

```bash
bash <(curl -fsSL https://github.com/kuss0/caddy.sh/raw/main/install.sh)
```

普通用户用 sudo：

```bash
wget -qO- https://github.com/kuss0/caddy.sh/raw/main/install.sh | sudo bash
```
